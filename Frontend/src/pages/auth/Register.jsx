...
import { FaEnvelope, FaLock, FaUser, FaUserPlus, FaHeartbeat, FaChevronDown } from 'react-icons/fa'
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <form onSubmit={onSubmit} className="w-full bg-white/90 backdrop-blur-xl p-6 rounded-[2rem] shadow-2xl border border-white/20">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold bg-gradient-to-r from-rose-600 to-purple-600 bg-clip-text text-transparent">Create Account</h1>
            <p className="text-gray-600 text-sm mt-1">Choose your role to proceed.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                Have an account? <Link to="/login" className="text-rose-600 font-semibold hover:text-rose-700 transition-colors">Login</Link>
              </p>
            </div>
          </div>
        </form>
